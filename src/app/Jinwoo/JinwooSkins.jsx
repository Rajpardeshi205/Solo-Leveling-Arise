...
export default function JinwooSkins() {
  ...
  return (
    <div className="w-full overflow-x-hidden">
      <Background>
        <div className="py-16 sm:py-20 md:py-24 text-white flex flex-col w-full h-screen pt-20">
          <main className="flex flex-col items-center justify-between px-4 sm:px-6 pb-6 gap-8">
            {/* Character Image */}
            ...
            {/* Carousel */}
            <div className="w-full max-w-xs sm:max-w-sm shrink-0 -mt-14">
              {" "}
